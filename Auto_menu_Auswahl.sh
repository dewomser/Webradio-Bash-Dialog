...
## oder statt "radio.txt" in der Zeile mpg123 …
# diese URL:
# https://raw.githubusercontent.com/dewomser/Webradio-Bash-Dialog/master/radio.txt
#eintippen
...
sender1=(1 DotFM8072 off)
sender2=(2 DotFM8042 off)
sender3=(3 SWR3 off)
